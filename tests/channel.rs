...
extern crate futures_spsc as spsc;
...
fn sequence() {
    ...
    fn send(n: u32, sender: spsc::Sender<u32>)
...
#[test]
fn drop_sender() {
    let (tx, mut rx) = spsc::channel::<u32>();
    drop(tx);
    sassert_done(&mut rx);
}
